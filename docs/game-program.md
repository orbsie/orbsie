...
A separate known gap remains for reflected procedural platforms: negative horizontal scale produces negative half-extents, and negative vertical scale needs transformed minimum/maximum bounds. Catalog and generated platform bounds already handle reflection. This requires a dedicated geometry regression before that case is considered complete.
